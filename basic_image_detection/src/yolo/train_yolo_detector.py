...
def main():
    ...
    if use_tfrecords and cct_tfrecords_dir and Path(cct_tfrecords_dir).exists():
        ...
        print("[Dataset] Using JSON pipeline")
        # Get filelists (will use splits file if explicit filelists not provided)
    ...
    if not use_tfrecords:
        ...
        # Placeholder metadata for TFRecords
